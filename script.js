const SITE_URL = 'https://thegreateryou.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'The Greater You — Sonic Remedy | Soozhee',
        text: 'Find the greater you, let your light show. The Greater You by Soozhee.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
